...
import 'package:plant_client/presentation/pages/temp_chart_history_page.dart';
        ...
        children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const TempChartHistoryPage()));
                  },
                  child: Text(
                    "View All >",
                    style: GoogleFonts.montserrat(
          ...
          BlocListener<HomeBloc, HomeState>(
            listener: (context, state) {
              if (state.status == HomeStatus.tempSuccess) {
